...
)Развернуть NEXT.js приложение в папке веб(там и апи роуты и веб)
-Правки дефолт значений
)Проверить версии либ и инструментов + прошерстить файл турбо + создать енв файл, настроить его шаринг и вынести пароли(монго в докере например) в него
